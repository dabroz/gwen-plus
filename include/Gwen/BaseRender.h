	...
	namespace Renderer
	{
		...
		class GWEN_EXPORT Base
		{
			public:
				...
				virtual Gwen::Color PixelColour( Gwen::Texture* pTexture, unsigned int x, unsigned int y, Gwen::Color& col_default = Gwen::Color( 255, 255, 255, 255 ) ){ return col_default; }
