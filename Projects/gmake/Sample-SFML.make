...
ifeq ($(config),release)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/SFMLSample.exe
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../../include
  ...
  LIBS      += ../../lib/gmake/libGWEN-Renderer-SFML.a ../../lib/gmake/libgwen_static.a ../../lib/gmake/libunittest.a
...
ifeq ($(config),debug)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/SFMLSample_D.exe
  DEFINES   += -D_DEBUG
  INCLUDES  += -I../../include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -mwindows -L../../lib/gmake
  LIBS      += ../../lib/gmake/libGWEN-Renderer-SFML.a ../../lib/gmake/libgwend_static.a ../../lib/gmake/libunittestd.a
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
